...
const Content = () => {
  return (
    <div className="relative z-20 mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36">
      ...
      >
        Register your booking with this portal
      </motion.h1>
      <motion.p
        initial={{
          y: 25,
      ...
      >
        MBA basin welcomes you for registering online vehile resevation/booking
        portal kindely signup with your deatils for accessing the portal .
      </motion.p>
      <motion.div
        initial={{
          y: 25,
